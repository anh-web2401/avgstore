...
<body>
    ...
    <div id="checkoutModal" class="modal">
        <div class="modal-content">
            ...
            <form method="POST" action="save_order.php" id="checkoutForm" onsubmit="return prepareSubmit()">
    ...
    <script>
            ...
            tbody.innerHTML = cart.map((item, index) => {
                ...
                return `
                    <tr>
                        ...
                        <td><button class="btn-delete" onclick="removeItem(${index})">🗑️ Xóa</button></td>
                    </tr>
                `;
            }).join('');
        ...
        // Hiển thị/ẩn thông tin thanh toán theo phương thức
        ...
        function prepareSubmit() {
            ...
            // Tính tổng tiền và tên sản phẩm
            let total = 0;
            let products = [];
            ...
            document.getElementById('product_name').value = products.join(', ');
            document.getElementById('total_price').value = total;
            
            // Hiển thị thông báo phương thức thanh toán
            let paymentMethod = document.getElementById('paymentMethod').value;
            if(paymentMethod !== 'COD') {
                let msg = '';
                if(paymentMethod === 'BANK_TRANSFER') {
                    msg = '🏦 Vui lòng chuyển khoản đến:\nVietcombank - 1234567890\nNội dung: AVG_' + new Date().getTime();
                } else if(paymentMethod === 'MOMO') {
                    msg = '📱 Vui lòng chuyển khoản Momo:\nSố điện thoại: 0987654321\nNội dung: AVG_' + fullname;
                }
                alert('📝 Lưu ý: ' + msg + '\n\nSau khi chuyển khoản, bạn nhấn OK để hoàn tất đơn hàng.');
            }
